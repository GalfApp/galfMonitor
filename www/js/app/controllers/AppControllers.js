...
AppControllers.controller('AppController', ['$scope', '$ionicModal', '$cordovaProgress', '$timeout', '$ionicListDelegate', 
    function($scope, $ionicModal, $cordovaProgress, $timeout, $ionicListDelegate) {
        ...
        $scope.sendMessage = function() {
            ...
            if (!$scope.lodash.isEmpty($scope.userToMessage) || $scope.data.broadcast) {
                ...
                sendMessagePromise.then(function(res) {
                    console.log('sendMessagePromise.then...')
                    console.log(res);
